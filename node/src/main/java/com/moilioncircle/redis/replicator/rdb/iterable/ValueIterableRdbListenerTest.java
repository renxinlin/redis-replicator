...
public class ValueIterableRdbListenerTest {
    ...
    public void test() {
        ...
        TestCase.assertEquals(4, map.get());
        TestCase.assertEquals(4, list.get());
        TestCase.assertEquals(4, set.get());
        TestCase.assertEquals(4, zset.get());
    }
    ...
    public void test2() {
        ...
        TestCase.assertEquals(5, stream.get());
    }
}