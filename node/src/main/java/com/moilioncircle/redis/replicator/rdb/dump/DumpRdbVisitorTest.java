...
public class DumpRdbVisitorTest {
    ...
    public void test1() {
        ...
        Assert.assertArrayEquals(string, astring.get());
        Assert.assertArrayEquals(set, aset.get());
        Assert.assertArrayEquals(zset, azset.get());
        Assert.assertArrayEquals(list, alist.get());
        Assert.assertArrayEquals(map, amap.get());
    }
}