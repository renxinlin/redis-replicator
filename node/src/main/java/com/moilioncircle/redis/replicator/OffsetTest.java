        ...
        r.addEventListener(new EventListener() {
            ...
            public void onEvent(Replicator replicator, Event event) {
                ...
                if (ae instanceof PreCommandSyncEvent) {
                    TestCase.assertEquals(0L, offset.getV1().longValue());
                    TestCase.assertEquals(0L, offset.getV2().longValue());
                }
                if (ae instanceof SetCommand) {
                    TestCase.assertEquals(23L, offset.getV1().longValue());
                    TestCase.assertEquals(50L, offset.getV2().longValue());
                }
                if (ae instanceof PostCommandSyncEvent) {
                    TestCase.assertEquals(135L, offset.getV1().longValue());
                    TestCase.assertEquals(135L, offset.getV2().longValue());
                }
            }
        });
        r.open();
            ...
            public void onEvent(Replicator replicator, Event event) {
                ...
                if (ae instanceof KeyValuePair<?, ?>) {
                    ...
                    if (key.equals("hll3")) {
                        ...
                        TestCase.assertEquals(611L, offset.getV1().longValue());
                        TestCase.assertEquals(620L, offset.getV2().longValue());
                    }
                }
                ...
                if (ae instanceof PostRdbSyncEvent) {
                    TestCase.assertEquals(745L, offset.getV1().longValue());
                    TestCase.assertEquals(754L, offset.getV2().longValue());
                }
            }
        });
