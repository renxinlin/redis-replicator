        ...
        for (KeyValuePair<byte[], ?> kv : list) {
            if (Strings.toString(kv.getKey()).equals("seri1")) {
                ...
                try {
                    ...
                    Assert.assertEquals("中文测试wuqioewqoi jdklsajf jslaj djsldfjlsjqweajdslfdl3019fjdsf9034930", obj.getA());
                    Assert.assertEquals(1000301032, obj.getB());
                    Assert.assertEquals(440910321039102L, obj.getC());
            ...
            if (Strings.toString(kv.getKey()).equals("seri2")) {
                ...
                try {
                    ...
                    Assert.assertEquals("中文测试12131", obj.getA());
                    Assert.assertEquals(1000301032, obj.getB());
                    Assert.assertEquals(440910321039102L, obj.getC());
                } catch (IOException | ClassNotFoundException e) {
                    Assert.fail();
            ...
            if (Strings.toString(kv.getKey()).equals("seri3")) {
                ...
                try {
                    Test obj = (Test) toObject(ksvs.getValue());
                    Assert.assertEquals("中文测试jfskdfjslf", obj.getA());
                    Assert.assertEquals(1000301032, obj.getB());
                    Assert.assertEquals(440910321039102L, obj.getC());
                } catch (IOException | ClassNotFoundException e) {
                    Assert.fail();
