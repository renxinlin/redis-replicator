...
public class StreamParserTest extends AbstractParserTest {
    ...
    public void parse() {
        ...
        
        {
            ...
            Assert.assertNull(cmd.getMaxLen());
            Assert.assertTrue(cmd.getFields().containsKey("field".getBytes()));
        }
        
        {
            ...
            Assert.assertFalse(cmd.getMaxLen().isApproximation());
            Assert.assertTrue(cmd.getFields().containsKey("field".getBytes()));
        }
        
        {
            ...
            assertEquals("*", cmd.getId());
            assertEquals(100L, cmd.getMaxLen().getCount());
            Assert.assertTrue(cmd.getMaxLen().isApproximation());
            Assert.assertTrue(cmd.getFields().containsKey("field".getBytes()));
            Assert.assertTrue(cmd.getFields().containsKey("field1".getBytes()));
        }
        ...
        
        {
            ...
            Assert.assertTrue(cmd.isForce());
            Assert.assertTrue(cmd.isJustId());
        }
        ...
        
        {
            ...
            Assert.assertNull(cmd.getIdle());
            Assert.assertNull(cmd.getTime());
            Assert.assertNull(cmd.getRetryCount());
            Assert.assertTrue(cmd.isForce());
            Assert.assertTrue(cmd.isJustId());
        }
        ...
        
        {
            ...
            Assert.assertNull(cmd.getTime());
            Assert.assertNull(cmd.getRetryCount());
            Assert.assertFalse(cmd.isForce());
            Assert.assertTrue(cmd.isJustId());
        }
        
        {
            ...
            Assert.assertNull(cmd.getRetryCount());
            Assert.assertFalse(cmd.isForce());
            Assert.assertFalse(cmd.isJustId());
        }
