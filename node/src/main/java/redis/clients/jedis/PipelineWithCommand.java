...
public class PipelineWithCommand extends MultiKeyPipelineBase implements Closeable {
  ...
  public Object send(final byte[] cmd, final byte[]... args) {
    Protocol.Command command = Protocol.Command.valueOf(Strings.toString(cmd).toUpperCase());
